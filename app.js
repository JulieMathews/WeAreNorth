    ...
    //storing and retreiving new directions data
      ...
      var service; //what is this for?
        ...
        service.getDistanceMatrix({
          ...
          travelMode: 'DRIVING,TRANSIT, WALKING, BICYCLE',
          unitSystem: google.maps.UnitSystem.IMPERIAL,
          drivingOptions: {
            departureTime: new Date(2019, 02, 14, 7, 0, 0, 0),// need user to chose a date and time - find a date picker
